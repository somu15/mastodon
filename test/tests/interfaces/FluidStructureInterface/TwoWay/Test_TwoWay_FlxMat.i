...
[InterfaceKernels]
  [./interface]
    type = FSIntFlxMat # FluidStructureInterface
    variable = disp_x
    neighbor_var = 'p'
...
[Materials]
  ...
  [./density0]
    ...
    block = '0'
    prop_names = density
    prop_values = 1000 # 2070 8050
  [../]
  [./elasticity_base]
    type = ComputeIsotropicElasticityTensor
    youngs_modulus = 1000 #2e11 5500
    poissons_ratio = 0.0
    block = '0'
  [../]
  [./strain]
...
[Outputs]
  ...
  file_base = Exodus_Test_1_FlxMat
  [./out]
    execute_on = 'TIMESTEP_BEGIN'
    type = CSV
    file_base = Test_1_FlxMat
  [../]
[]
