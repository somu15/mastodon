...
registerMooseObject("MastodonApp", IntDiff);
...
IntDiff::IntDiff(const InputParameters & parameters)
...
Real
IntDiff::computeQpResidual(Moose::DGResidualType type)
{
  Real r = 0;
...
Real
IntDiff::computeQpJacobian(Moose::DGJacobianType type)
{
  Real jac = 0;
