...
ElementSizeIndicator::validParams()
{
  ...
  params.addParam<MaterialPropertyName>("element_size",
                                        "element_size",
                                        "The value of the material that will control the mesh refinement.");
  params.addClassDescription("Computes the minimum element size based on the material value.");
  return params;
}
