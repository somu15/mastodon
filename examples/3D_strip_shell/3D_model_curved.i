...
[Postprocessors]
  [./p_1]
    type = PointValue
    point = '-0.7696 0.0 0.0'
    variable = p
  [../]
  [./p_2]
    type = PointValue
    point = '-2.9905 0.0 0.0'
    variable = p
  [../]
  [./stress1_1]
    type = PointValue
    point = '-0.7694 0.0 0.0'
    variable = stress_xx
  [../]
  [./stress2_1]
    type = PointValue
...
[Outputs]
  ...
  file_base = Ex_Test_solidshell_curved_disp1
  [./out]
    execute_on = 'TIMESTEP_BEGIN'
    type = CSV
    file_base = Test_solidshell_curved_disp1
  [../]
[]
