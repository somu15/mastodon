[Mesh]
  [mesh_gen]
    ...
    file = structure_1_solids_merged_RV_isolators.e
  []
  [./interface1]
...
[Postprocessors]
  ...
  [./Iso1_Bot_ReacX]
    type = PointValue
    point = '-17.85 0.0 8.375' # '-15.0 -2.85 8.375'
    variable = reaction_x
  [../]
  [./Iso1_Bot_DispX]
    type = PointValue
  ...
  [./Iso1_Top_ReacX]
    type = PointValue
    point = '-17.85 0.0 8.695' # '-15.0 -3.010056 8.675'
    variable = reaction_x
  [../]
  [./Iso1_Top_DispX]
    type = PointValue
  ...
  [./Moment_Out_y]
    ...
    boundary = 'Top'
    reference_point = '-15.0 0.0 8.695' # 7.645
  ...
  [./Moment_Out_x]
    ...
    stress_tensor = stress
    boundary = 'Top'
    reference_point = '-15.0 0.0 8.695'
  ...
  [./Wave1]
    type = PointValue
    point = '-17.235 0.0 7.725'
    variable = Wave1
  [../]
  [./Wave2]
    type = PointValue
    point = '-16.337652 0.00157 7.725'
    variable = Wave1
  [../]
  [./Wave3]
    type = PointValue
    point = '-15.0 0.0 7.725'
    variable = Wave1
  [../]
  [./Wave4]
    type = PointValue
    point = '-13.662403 -0.0011 7.725'
    variable = Wave1
  [../]
  [./Wave5]
    type = PointValue
    point = '-12.765 0.0 7.725'
    variable = Wave1
  [../]

  [p1_n]
    type = PointValue
    point = '-17.48 0.0 7.725'
    variable = p
  []
  [p2_n]
    type = PointValue
    point = '-17.48 0.0 6.925'
    variable = p
  []
  [p3_n]
    type = PointValue
    point = '-17.48 0.0 6.325'
    variable = p
  []
  [p4_n]
    type = PointValue
    point = '-17.48 0.0 5.525'
    variable = p
  []
  [p5_n]
    type = PointValue
    point = '-17.48 0.0 4.725'
    variable = p
  []
  [p6_n]
    type = PointValue
    point = '-17.48 0.0 3.925'
    variable = p
  []

  [p1_p]
    type = PointValue
    point = '-12.52 0.0 7.725'
    variable = p
  []
  [p2_p]
    type = PointValue
    point = '-12.52 0.0 6.925'
    variable = p
  []
  [p3_p]
    type = PointValue
    point = '-12.52 0.0 6.325'
    variable = p
  []
  [p4_p]
    type = PointValue
    point = '-12.52 0.0 5.525'
    variable = p
  []
  [p5_p]
    type = PointValue
    point = '-12.52 0.0 4.725'
    variable = p
  []
  [p6_p]
    type = PointValue
    point = '-12.52 0.0 3.925'
    variable = p
  []
...
[VectorPostprocessors]
  [./accel_hist_x]
    ...
    nodes = '48138 28492 29362 29204 28906'
    outputs = out1
    block = 'roof ext_buttresses ext_walls int_buttresses SG_bases int_wall int_slab RV_housing small_walls basemat RV SGs RV_slab' # 99 98 97 96 95 94'
  [../]
  [./accel_spec_x]
